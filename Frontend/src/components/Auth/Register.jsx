...
function Register() {
          ...
          >
            <div className="text-center">
              ...
              <p className="text-secondary medium px-3">
                Create an account to explore thousands of job opportunities and hire top talent.
              </p>
            </div>
          </div>
          ...
          >
            <div className="w-100" style={{ maxWidth: "420px" }}>
              ...
              <div className="mb-4 text-start">
                ...
                <p className="text-secondary medium">Create an account to find your dream job or hire top talent.</p>
              </div>
  ...
  onChange={handleChange}
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold mb-1 text-dark small">Email Address</label>
                  <input
                    type="email"
                    className="form-control py-2 shadow-none border-light-subtle"
  ...
  onChange={handleChange}
                ...
                <div className="form-check mb-4">
                  <input className="form-check-input shadow-none" type="checkbox" id="terms" />
                  <label className="form-check-label medium text-secondary" htmlFor="terms">
                    I agree to the <span className="text-primary fw-bold">Terms & Service</span>
                  </label>
                </div>
                ...
                <div className="d-flex align-items-center my-3">
                  ...
                  <span className="mx-3 text-secondary small fw-bold" style={{fontSize: '0.8rem'}}>OR</span>
                  <hr className="flex-grow-1 text-muted opacity-25" />
                </div>
